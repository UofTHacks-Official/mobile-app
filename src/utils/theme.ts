export const getThemeStyles = (isDark: boolean) => ({
  ...
  lightCardBackground: isDark ? "bg-[#303030]" : "bg-gray-200",
  ...
  skipButtonColor: isDark ? "text-gray-300" : "text-gray-500",

  // Icon colors
  iconColor: isDark ? "#FFF" : "#000",

  // Theme toggle specific styles
  toggleButtonBackground: isDark ? "bg-[#303030]" : "bg-gray-200",
  ...
  // Button Color
  primaryButtonColor: isDark ? "uoft_primary_blue" : "uoft_primary_blue_dark",
  primaryButtonColorBg: isDark
    ? "bg-uoft_primary_blue"
    : "bg-uoft_primary_blue_dark",
